...
./build/clash2tfhe -cjson tests/programs/AES/AESencrypt128bit.json -n 12 ct_in_0.data ct_key_0.data ct_key_1.data ct_key_2.data ct_key_3.data ct_key_4.data ct_key_5.data ct_key_6.data ct_key_7.data ct_key_8.data ct_key_9.data ct_key_10.data  -out result.data -boot boots.key -b 128 -t 5
